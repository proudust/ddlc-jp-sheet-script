...
describe("UseUnknownAttributesChecker", () => {
  const UseUnknownAttributesChecker = new RenPyChecker
...
describe("UnificationEllipsisChecker", () => {
  const UnificationEllipsisChecker = new RenPyChecker
...
describe("CantIncludeSpaceInWaitTagsChecker", () => {
  const CantIncludeSpaceInWaitTagsChecker = new RenPyChecker
...
describe("CantIncludeHalfWidthChecker", () => {
  const CantIncludeHalfWidthChecker = new RenPyChecker
